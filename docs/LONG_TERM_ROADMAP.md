...
#### 11.X.BE PR: smoke:skill HTTP smoke script (skill state machine + auto-grant starter + equip/unequip/upgrade-mastery negative paths + anti-FE-self-grant invariant) — PENDING MERGE (this push)
