...
#### 11.X.BJ PR: smoke:giftcode HTTP smoke script (1 giftcode endpoint redeem auth gate + zod/service input validation + NO_CHARACTER pre-onboard + CODE_NOT_FOUND post-onboard + anti-FE-self-grant invariant) — PENDING MERGE (this push)
