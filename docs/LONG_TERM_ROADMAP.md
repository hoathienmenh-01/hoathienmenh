...
#### 11.X.BI PR: smoke:mail HTTP smoke script (4 mail endpoints me/unread-count/read/claim auth gate + NO_CHARACTER fallback + MAIL_NOT_FOUND/INVALID_INPUT negative paths + anti-FE-self-grant invariant) — PENDING MERGE (this push)
