...
#### 11.X.BK PR: smoke:mission HTTP smoke script (2 mission endpoints me/claim auth gate + zod input validation + service order MISSION_UNKNOWN trước NO_CHARACTER + NOT_READY post-onboard fresh + shape contract + anti-FE-self-grant invariant) — PENDING MERGE (this push)
