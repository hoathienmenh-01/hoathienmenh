...
#### 11.X.BG PR: smoke:next-action HTTP smoke script (smart next-action recommendation state machine reactivity + shape contract + NO_CHARACTER short-circuit + cultivate toggle reactive 2 chiều) — PENDING MERGE (this push)
