...
#### 11.X.BL PR: smoke:achievement HTTP smoke script (2 achievement endpoints achievements/achievement-claim auth gate + zod input validation + controller order char trước service catalog + ACHIEVEMENT_NOT_FOUND post-onboard + NOT_FOUND_PROGRESS fresh char + shape contract + anti-FE-self-grant invariant) — PENDING MERGE (this push)
