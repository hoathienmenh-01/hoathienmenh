...
#### 11.X.BF PR: smoke:daily-login HTTP smoke script (daily login claim state machine + idempotent guard + ledger applyTx server-authoritative balance + anti-FE-self-grant invariant) — PENDING MERGE (this push)
