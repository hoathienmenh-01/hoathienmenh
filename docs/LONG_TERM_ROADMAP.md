...
#### 11.X.BD PR: smoke:cultivation-method HTTP smoke script (công pháp state machine + auto-grant starter + equip negative paths + anti-FE-self-grant invariant) — PENDING MERGE (this push)
