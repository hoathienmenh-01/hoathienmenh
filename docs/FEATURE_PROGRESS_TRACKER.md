...
|---|---|---|---|---|---|---|---|
| 1 | Daily Loop First Session Polish | TODO | New players need a clear first-session path; this is the highest-impact beta polish. | Improve priority, copy, reward hints, completion states, and CTAs on home/daily loop. | `DailyLoopPanel.vue`, `HomeView.vue`, `NextActionPanel.vue`, optional `player-dashboard` | Fresh character sees 3-5 best actions with route, state, and reward hint; completed actions de-prioritized. | 2026-05-19 |
