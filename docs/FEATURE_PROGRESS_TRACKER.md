...
`Alchemy V2 Polish` or `Sect Create/Join/Contribute Smoke`

## Active Task Template

### Active Task

- Task: Co-op & Social Views Polish
- Branch: feat/coop-social-ux-polish
- Started: 2026-05-19
- Owner: AI
- Status: DONE
- Files touched: `PartyDungeonView.vue`, `CoopBossView.vue`, `SectView.vue`, `TribulationView.vue`, `vi.json`, `en.json`, 4 test files
- Tests run: typecheck, lint, build, Han gate, PartyDungeonView 10/10, CoopBossView 10/10, SectView 15/15, TribulationView 101/101
