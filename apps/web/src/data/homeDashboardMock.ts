...
export const mobileIconGrid: HomeFeatureCard[] = [
  ...
  { key: 'equipment', label: 'Trang bị', description: '', glyph: '⚔', tone: 'gold', to: '/loadouts', badge: 1 },
  { key: 'missions', label: 'Nhiệm vụ', description: '', glyph: '✎', tone: 'gold', to: '/missions', badge: 3 },
  ...
  { key: 'mail', label: 'Thư', description: '', glyph: '✉', tone: 'cyan', to: '/mail', badge: 3 },
  { key: 'friends', label: 'Bạn bè', description: '', glyph: '☘', tone: 'jade', to: '/social', badge: 1 },
