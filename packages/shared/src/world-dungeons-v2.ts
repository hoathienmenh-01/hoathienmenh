...
export const DUNGEONS_V2: readonly DungeonV2Def[] = [
  // ─── 1. Bí cảnh luyện đan (ALCHEMY_MATERIAL) ────────────────────────────
  {
    ...
    dailyAttempts: 3,
    sweepAllowed: true,
    firstClearReward: { linhThach: 80, exp: 150, items: [{ itemKey: 'linh_thao', qty: 3 }, { itemKey: 'skill_book_moc_linh_truong_dieu', qty: 1 }] },
  ...
  // ─── 2. Bí cảnh luyện thể (BODY_MATERIAL) ───────────────────────────────
  {
    ...
    dailyAttempts: 3,
    sweepAllowed: true,
    firstClearReward: { linhThach: 80, exp: 150, items: [{ itemKey: 'huyet_chi_dan', qty: 1 }, { itemKey: 'skill_book_kim_quang_tram', qty: 1 }] },
