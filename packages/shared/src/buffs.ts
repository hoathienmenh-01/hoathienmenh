...
export const BUFFS: readonly BuffDef[] = [
  ...
  {
    key: 'buff_pill_huyet_luc',
    name: 'Huyết Lực Đan Ấn',
    description: 'Huyết khí bốc lên, công kích +8% trong 90 giây.',
    polarity: 'buff',
    element: null,
    source: 'pill',
    durationSec: 90,
  ...
  {
    key: 'buff_pill_than_niem',
    name: 'Thần Niệm Đan Ấn',
    description: 'Thần niệm ngưng tụ, spirit +12% trong 120 giây.',
    polarity: 'buff',
    element: null,
    source: 'pill',
    durationSec: 120,
  ...
  {
    key: 'buff_pill_can_khon',
    name: 'Càn Khôn Đan Ấn',
    description: 'Càn khôn hộ thân, phòng ngự +14% trong 120 giây.',
    polarity: 'buff',
    element: null,
    source: 'pill',
    durationSec: 120,
  ...
  {
    key: 'buff_pill_dao_van',
    name: 'Đạo Văn Đan Ấn',
    description: 'Đạo văn quanh thân, phòng ngự +10% trong 150 giây.',
    polarity: 'buff',
    element: null,
    source: 'pill',
    durationSec: 150,
