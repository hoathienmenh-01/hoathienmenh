...
export const TITLES: readonly TitleDef[] = [
  ...
  {
    key: 'phase46_title_pet_bonder',
    nameVi: 'Linh Thú Hữu Duyên',
    nameEn: 'Spirit Beast Bonded',
    description: 'Danh hiệu cosmetic cho người bắt đầu duyên linh thú.',
    rarity: 'common',
    source: 'achievement',
    element: null,
    unlockRealmKey: null,
    unlockAchievementKey: 'phase46_pet_bond_first',
    unlockSectRole: null,
    flavorStatBonus: null,
  },
  {
    key: 'phase46_title_boss_watcher',
    nameVi: 'Yêu Vương Kiến Chứng',
    nameEn: 'Boss Witness',
    description: 'Danh hiệu cosmetic cho người đều đặn tham chiến boss.',
    rarity: 'rare',
    source: 'achievement',
    element: null,
    unlockRealmKey: null,
    unlockAchievementKey: 'phase46_boss_first_stand',
    unlockSectRole: null,
    flavorStatBonus: null,
  },
  {
    key: 'phase46_title_sect_regular',
    nameVi: 'Tông Môn Thường Cần',
    nameEn: 'Steady Sect Regular',
    description: 'Danh hiệu cosmetic ghi nhận đóng góp tông môn bền bỉ.',
    rarity: 'rare',
    source: 'achievement',
    element: null,
    unlockRealmKey: null,
    unlockAchievementKey: 'phase46_sect_regular',
    unlockSectRole: null,
    flavorStatBonus: null,
  },
