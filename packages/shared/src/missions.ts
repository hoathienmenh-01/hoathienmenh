...
export const MISSIONS: readonly MissionDef[] = [
  ...
  {
    key: 'daily_phase21_story_17',
    name: 'Nhật khoá Phase 21 17',
    description: 'Daily capped gắn với guided path/story activity Phase 21; thưởng nhỏ để không phá economy.',
    period: 'DAILY',
    goalKind: 'CULTIVATE_SECONDS',
    goalAmount: 900,
    requiredRealmOrder: 5,
    quality: 'HUYEN',
    rewards: { linhThach: 175, exp: 486, congHien: 13 },
    element: null,
    regionKey: 'hac_lam',
  ...
  },
  {
    ...
    requiredRealmOrder: 1,
    quality: 'LINH',
    rewards: { linhThach: 185, exp: 522, congHien: 15 },
    element: 'moc',
  ...
  },
  {
    ...
    quality: 'HUYEN',
    rewards: { linhThach: 190, exp: 540, congHien: 16 },
    element: 'thuy',
  ...
  },
  {
    ...
    quality: 'PHAM',
    rewards: { linhThach: 195, exp: 558, congHien: 17 },
    element: 'hoa',
  ...
  },
  {
    ...
    quality: 'LINH',
    rewards: { linhThach: 200, exp: 576, congHien: 18 },
    element: 'tho',
  ...
  },
  {
    ...
    requiredRealmOrder: 5,
    quality: 'HUYEN',
    rewards: { linhThach: 205, exp: 594, congHien: 19 },
    element: null,
  ...
  },
  {
    ...
    requiredRealmOrder: 1,
    quality: 'LINH',
    rewards: { linhThach: 215, exp: 630, congHien: 9 },
    element: 'moc',
    regionKey: 'hac_lam',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 2,
    quality: 'HUYEN',
    rewards: { linhThach: 220, exp: 648, congHien: 10 },
    element: 'thuy',
    regionKey: 'yeu_thu_dong',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 3,
    quality: 'PHAM',
    rewards: { linhThach: 225, exp: 666, congHien: 11 },
    element: 'hoa',
    regionKey: 'kim_son_mach',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 4,
    quality: 'LINH',
    rewards: { linhThach: 230, exp: 684, congHien: 12 },
    element: 'tho',
    regionKey: 'moc_huyen_lam',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 5,
    quality: 'HUYEN',
    rewards: { linhThach: 235, exp: 702, congHien: 13 },
    element: null,
    regionKey: 'thuy_long_uyen',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  ...
  },
  {
    ...
    requiredRealmOrder: 1,
    quality: 'LINH',
    rewards: { linhThach: 245, exp: 738, congHien: 15 },
    element: 'moc',
    regionKey: 'hoang_tho_huyet',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 2,
    quality: 'HUYEN',
    rewards: { linhThach: 250, exp: 756, congHien: 16 },
    element: 'thuy',
    regionKey: 'son_coc',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 3,
    quality: 'PHAM',
    rewards: { linhThach: 255, exp: 774, congHien: 17 },
    element: 'hoa',
    regionKey: 'hac_lam',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 4,
    quality: 'LINH',
    rewards: { linhThach: 260, exp: 792, congHien: 18 },
    element: 'tho',
    regionKey: 'yeu_thu_dong',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 5,
    quality: 'HUYEN',
    rewards: { linhThach: 265, exp: 810, congHien: 19 },
    element: null,
    regionKey: 'kim_son_mach',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  ...
  },
  {
    ...
    requiredRealmOrder: 1,
    quality: 'LINH',
    rewards: { linhThach: 275, exp: 846, congHien: 9 },
    element: 'moc',
    regionKey: 'thuy_long_uyen',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 2,
    quality: 'HUYEN',
    rewards: { linhThach: 280, exp: 864, congHien: 10 },
    element: 'thuy',
    regionKey: 'hoa_diem_son',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 3,
    quality: 'PHAM',
    rewards: { linhThach: 285, exp: 882, congHien: 11 },
    element: 'hoa',
    regionKey: 'hoang_tho_huyet',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 4,
    quality: 'LINH',
    rewards: { linhThach: 290, exp: 900, congHien: 12 },
    element: 'tho',
    regionKey: 'son_coc',
    storyChainKey: 'phase21_daily_guided_path',
    realmTier: 'truc_co',
  ...
  // ----- MID-GAME DAILY (realm 5-9: hoa_than → do_kiep) -----
  {
    key: 'daily_midgame_clear_dungeon_r5',
    name: 'Hoá thần phá trận',
    description: 'Hoàn thành 3 phó bản trong ngày (yêu cầu Hoá Thần).',
    period: 'DAILY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 3,
    requiredRealmOrder: 5,
    quality: 'HUYEN',
    rewards: { linhThach: 250, exp: 600 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_kill_monster_r6',
    name: 'Luyện hư trảm yêu',
    description: 'Hạ gục 12 yêu thú trong ngày (yêu cầu Luyện Hư).',
    period: 'DAILY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 12,
    requiredRealmOrder: 6,
    quality: 'HUYEN',
    rewards: { linhThach: 280, exp: 700 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_boss_hit_r5',
    name: 'Hoá thần chiến boss',
    description: 'Đánh trúng Thế Giới Boss 5 lần trong ngày (yêu cầu Hoá Thần).',
    period: 'DAILY',
    goalKind: 'BOSS_HIT',
    goalAmount: 5,
    requiredRealmOrder: 5,
    quality: 'TIEN',
    rewards: { linhThach: 300, congHien: 40 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_cultivate_r6',
    name: 'Luyện hư tu hành',
    description: 'Tu luyện liên tục 20 phút (1200 giây) trong ngày (yêu cầu Luyện Hư).',
    period: 'DAILY',
    goalKind: 'CULTIVATE_SECONDS',
    goalAmount: 1200,
    requiredRealmOrder: 6,
    quality: 'HUYEN',
    rewards: { linhThach: 260, exp: 800 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_clear_dungeon_r7',
    name: 'Hợp thể phá trận',
    description: 'Hoàn thành 4 phó bản trong ngày (yêu cầu Hợp Thể).',
    period: 'DAILY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 4,
    requiredRealmOrder: 7,
    quality: 'TIEN',
    rewards: { linhThach: 320, exp: 900 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_alchemy_r7',
    name: 'Hợp thể luyện đan',
    description: 'Luyện thành công 2 viên đan dược trong ngày (yêu cầu Hợp Thể).',
    period: 'DAILY',
    goalKind: 'ALCHEMY_CRAFT',
    goalAmount: 2,
    requiredRealmOrder: 7,
    quality: 'TIEN',
    rewards: { linhThach: 340, exp: 700, items: [{ itemKey: 'cuu_huyen_dan', qty: 1 }] },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_kill_monster_r8',
    name: 'Đại thừa trảm yêu',
    description: 'Hạ gục 15 yêu thú trong ngày (yêu cầu Đại Thừa).',
    period: 'DAILY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 15,
    requiredRealmOrder: 8,
    quality: 'TIEN',
    rewards: { linhThach: 360, exp: 1000 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_cultivate_r8',
    name: 'Đại thừa tu hành',
    description: 'Tu luyện liên tục 25 phút (1500 giây) trong ngày (yêu cầu Đại Thừa).',
    period: 'DAILY',
    goalKind: 'CULTIVATE_SECONDS',
    goalAmount: 1500,
    requiredRealmOrder: 8,
    quality: 'TIEN',
    rewards: { linhThach: 380, exp: 1100 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_boss_hit_r9',
    name: 'Độ kiếp chiến boss',
    description: 'Đánh trúng Thế Giới Boss 6 lần trong ngày (yêu cầu Độ Kiếp).',
    period: 'DAILY',
    goalKind: 'BOSS_HIT',
    goalAmount: 6,
    requiredRealmOrder: 9,
    quality: 'TIEN',
    rewards: { linhThach: 400, congHien: 50 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  {
    key: 'daily_midgame_sect_contribute_r9',
    name: 'Độ kiếp cống hiến',
    description: 'Đóng góp 300 linh thạch cho tông môn trong ngày (yêu cầu Độ Kiếp).',
    period: 'DAILY',
    goalKind: 'SECT_CONTRIBUTE',
    goalAmount: 300,
    requiredRealmOrder: 9,
    quality: 'TIEN',
    rewards: { congHien: 80, linhThach: 150 },
    element: null,
    regionKey: null,
    realmTier: null,
  },
  ...
  {
    key: 'weekly_phase21_story_16',
    name: 'Chu khoá Phase 21 16',
    description: 'Weekly capped khuyến khích dungeon/boss/sect/co-op story rhythm của Phase 21.',
    period: 'WEEKLY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 5,
    requiredRealmOrder: 4,
    quality: 'HUYEN',
    rewards: { linhThach: 902, exp: 2680, congHien: 61 },
    element: null,
    regionKey: 'yeu_thu_dong',
  ...
  },
  {
    ...
    requiredRealmOrder: 5,
    quality: 'PHAM',
    rewards: { linhThach: 924, exp: 2760, congHien: 62 },
    element: 'kim',
    regionKey: 'kim_son_mach',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  ...
  },
  {
    ...
    requiredRealmOrder: 1,
    quality: 'HUYEN',
    rewards: { linhThach: 968, exp: 2920, congHien: 64 },
    element: 'thuy',
    regionKey: 'thuy_long_uyen',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 2,
    quality: 'PHAM',
    rewards: { linhThach: 990, exp: 3000, congHien: 65 },
    element: 'hoa',
    regionKey: 'hoa_diem_son',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 3,
    quality: 'LINH',
    rewards: { linhThach: 1012, exp: 3080, congHien: 66 },
    element: 'tho',
    regionKey: 'hoang_tho_huyet',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 4,
    quality: 'HUYEN',
    rewards: { linhThach: 1034, exp: 3160, congHien: 67 },
    element: null,
    regionKey: 'son_coc',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 5,
    quality: 'PHAM',
    rewards: { linhThach: 1056, exp: 3240, congHien: 68 },
    element: 'kim',
    regionKey: 'hac_lam',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  ...
  },
  {
    ...
    requiredRealmOrder: 1,
    quality: 'HUYEN',
    rewards: { linhThach: 1100, exp: 3400, congHien: 70 },
    element: 'thuy',
    regionKey: 'kim_son_mach',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 2,
    quality: 'PHAM',
    rewards: { linhThach: 1122, exp: 3480, congHien: 71 },
    element: 'hoa',
    regionKey: 'moc_huyen_lam',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 3,
    quality: 'LINH',
    rewards: { linhThach: 1144, exp: 3560, congHien: 72 },
    element: 'tho',
    regionKey: 'thuy_long_uyen',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 4,
    quality: 'HUYEN',
    rewards: { linhThach: 1166, exp: 3640, congHien: 73 },
    element: null,
    regionKey: 'hoa_diem_son',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  },
  {
    ...
    requiredRealmOrder: 5,
    quality: 'PHAM',
    rewards: { linhThach: 1188, exp: 3720, congHien: 74 },
    element: 'kim',
    regionKey: 'hoang_tho_huyet',
    storyChainKey: 'phase21_weekly_story_loop',
    realmTier: 'truc_co',
  ...
  // ----- MID-GAME WEEKLY (realm 5-9: hoa_than → do_kiep) -----
  {
    key: 'weekly_midgame_clear_dungeon_r5',
    name: 'Hoá thần tuần đãng',
    description: 'Hoàn thành 20 phó bản trong tuần (yêu cầu Hoá Thần).',
    period: 'WEEKLY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 20,
    requiredRealmOrder: 5,
    quality: 'TIEN',
    rewards: { linhThach: 1200, exp: 3000, items: [{ itemKey: 'thanh_lam_dan', qty: 3 }] },
    realmTier: 'hoa_than',
  },
  {
    key: 'weekly_midgame_kill_monster_r6',
    name: 'Luyện hư tuần trảm',
    description: 'Hạ gục 60 yêu thú trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 60,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 1400, exp: 3500 },
    realmTier: 'luyen_hu',
  },
  {
    key: 'weekly_midgame_boss_hit_r5',
    name: 'Hoá thần tuần chiến',
    description: 'Đánh trúng Thế Giới Boss 30 lần trong tuần (yêu cầu Hoá Thần).',
    period: 'WEEKLY',
    goalKind: 'BOSS_HIT',
    goalAmount: 30,
    requiredRealmOrder: 5,
    quality: 'TIEN',
    rewards: { linhThach: 1500, congHien: 200 },
    realmTier: 'hoa_than',
  },
  {
    key: 'weekly_midgame_clear_dungeon_r7',
    name: 'Hợp thể tuần đãng',
    description: 'Hoàn thành 25 phó bản trong tuần (yêu cầu Hợp Thể).',
    period: 'WEEKLY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 25,
    requiredRealmOrder: 7,
    quality: 'TIEN',
    rewards: { linhThach: 1600, exp: 4000, items: [{ itemKey: 'cuu_huyen_dan', qty: 3 }] },
    realmTier: 'hop_the',
  },
  {
    key: 'weekly_midgame_kill_monster_r7',
    name: 'Hợp thể tuần trảm',
    description: 'Hạ gục 70 yêu thú trong tuần (yêu cầu Hợp Thể).',
    period: 'WEEKLY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 70,
    requiredRealmOrder: 7,
    quality: 'TIEN',
    rewards: { linhThach: 1700, exp: 4200 },
    realmTier: 'hop_the',
  },
  {
    key: 'weekly_midgame_breakthrough_r6',
    name: 'Luyện hư đột phá',
    description: 'Đột phá thành công 1 lần trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'BREAKTHROUGH',
    goalAmount: 1,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 1300, exp: 3800, items: [{ itemKey: 'thanh_lam_dan', qty: 2 }] },
    realmTier: 'luyen_hu',
  },
  {
    key: 'weekly_midgame_kill_monster_r8',
    name: 'Đại thừa tuần trảm',
    description: 'Hạ gục 80 yêu thú trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 80,
    requiredRealmOrder: 8,
    quality: 'TIEN',
    rewards: { linhThach: 1800, exp: 4500 },
    realmTier: null,
  },
  {
    key: 'weekly_midgame_alchemy_r8',
    name: 'Đại thừa tuần luyện',
    description: 'Luyện thành công 10 viên đan dược trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'ALCHEMY_CRAFT',
    goalAmount: 10,
    requiredRealmOrder: 8,
    quality: 'TIEN',
    rewards: { linhThach: 1900, exp: 4000, items: [{ itemKey: 'cuu_huyen_dan', qty: 4 }] },
    realmTier: null,
  },
  {
    key: 'weekly_midgame_clear_dungeon_r9',
    name: 'Độ kiếp tuần đãng',
    description: 'Hoàn thành 30 phó bản trong tuần (yêu cầu Độ Kiếp).',
    period: 'WEEKLY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 30,
    requiredRealmOrder: 9,
    quality: 'THAN',
    rewards: { linhThach: 2000, exp: 5000, items: [{ itemKey: 'cuu_thien_dan', qty: 3 }] },
    realmTier: 'do_kiep',
  },
  {
    key: 'weekly_midgame_boss_hit_r9',
    name: 'Độ kiếp tuần chiến',
    description: 'Đánh trúng Thế Giới Boss 40 lần trong tuần (yêu cầu Độ Kiếp).',
    period: 'WEEKLY',
    goalKind: 'BOSS_HIT',
    goalAmount: 40,
    requiredRealmOrder: 9,
    quality: 'THAN',
    rewards: { linhThach: 2100, congHien: 250 },
    realmTier: 'do_kiep',
  },
  ...
  // ---------- DAILY tier 5 (Luyện Hư / Hợp Thể — realm order 6-7) ----------
  {
    key: 'daily_T5_cultivate_14400s',
    name: 'Luyện hư đại tu',
    description: 'Đạo hữu Luyện Hư tu luyện đủ 4 giờ (14400 giây) trong ngày.',
    period: 'DAILY',
    goalKind: 'CULTIVATE_SECONDS',
    goalAmount: 14400,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 20000, exp: 30000 },
    realmTier: 'luyen_hu',
  },
  {
    key: 'daily_T5_kill_monster_80',
    name: 'Luyện hư trảm yêu',
    description: 'Hạ gục 80 yêu thú trong ngày (yêu cầu Luyện Hư).',
    period: 'DAILY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 80,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 20000, exp: 16000, items: [{ itemKey: 'cuu_thien_dan', qty: 2 }] },
    realmTier: 'luyen_hu',
  },
  {
    key: 'daily_T5_clear_dungeon_5',
    name: 'Luyện hư đãng trận',
    description: 'Hoàn thành 5 phó bản trong ngày (yêu cầu Luyện Hư).',
    period: 'DAILY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 5,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 20000, exp: 24000 },
    realmTier: 'luyen_hu',
  },
  {
    key: 'daily_T5_boss_hit_5',
    name: 'Luyện hư chiến boss',
    description: 'Đánh trúng Thế Giới Boss 5 lần trong ngày (yêu cầu Luyện Hư).',
    period: 'DAILY',
    goalKind: 'BOSS_HIT',
    goalAmount: 5,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 22000, exp: 18000, congHien: 50 },
    realmTier: 'luyen_hu',
  },
  {
    key: 'daily_T5_sect_contribute_500',
    name: 'Luyện hư cống hiến',
    description: 'Cống hiến 500 điểm cho tông môn trong ngày (yêu cầu Luyện Hư).',
    period: 'DAILY',
    goalKind: 'SECT_CONTRIBUTE',
    goalAmount: 500,
    requiredRealmOrder: 6,
    quality: 'TIEN',
    rewards: { linhThach: 18000, exp: 12000, congHien: 100 },
    realmTier: 'luyen_hu',
  },

  // ---------- DAILY tier 6 (Đại Thừa / Độ Kiếp — realm order 8-9) ----------
  {
    key: 'daily_T6_cultivate_18000s',
    name: 'Đại thừa đại tu',
    description: 'Đạo hữu Đại Thừa tu luyện đủ 5 giờ (18000 giây) trong ngày.',
    period: 'DAILY',
    goalKind: 'CULTIVATE_SECONDS',
    goalAmount: 18000,
    requiredRealmOrder: 8,
    quality: 'THAN',
    rewards: { linhThach: 40000, exp: 60000 },
    realmTier: 'dai_thua',
  },
  {
    key: 'daily_T6_kill_monster_120',
    name: 'Đại thừa trảm yêu',
    description: 'Hạ gục 120 yêu thú trong ngày (yêu cầu Đại Thừa).',
    period: 'DAILY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 120,
    requiredRealmOrder: 8,
    quality: 'THAN',
    rewards: { linhThach: 40000, exp: 32000, items: [{ itemKey: 'than_dan', qty: 1 }] },
    realmTier: 'dai_thua',
  },
  {
    key: 'daily_T6_clear_dungeon_6',
    name: 'Đại thừa đãng trận',
    description: 'Hoàn thành 6 phó bản trong ngày (yêu cầu Đại Thừa).',
    period: 'DAILY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 6,
    requiredRealmOrder: 8,
    quality: 'THAN',
    rewards: { linhThach: 40000, exp: 48000 },
    realmTier: 'dai_thua',
  },
  {
    key: 'daily_T6_boss_hit_8',
    name: 'Đại thừa chiến boss',
    description: 'Đánh trúng Thế Giới Boss 8 lần trong ngày (yêu cầu Đại Thừa).',
    period: 'DAILY',
    goalKind: 'BOSS_HIT',
    goalAmount: 8,
    requiredRealmOrder: 8,
    quality: 'THAN',
    rewards: { linhThach: 45000, exp: 36000, congHien: 100 },
    realmTier: 'dai_thua',
  },
  {
    key: 'daily_T6_alchemy_craft_3',
    name: 'Đại thừa luyện đan',
    description: 'Luyện thành công 3 viên đan dược trong ngày (yêu cầu Đại Thừa).',
    period: 'DAILY',
    goalKind: 'ALCHEMY_CRAFT',
    goalAmount: 3,
    requiredRealmOrder: 8,
    quality: 'THAN',
    rewards: { linhThach: 38000, exp: 20000, items: [{ itemKey: 'than_dan', qty: 1 }] },
    realmTier: 'dai_thua',
  },

  // ---------- WEEKLY tier 5 (Luyện Hư / Hợp Thể — realm order 6-7) ----------
  {
    key: 'weekly_T5_clear_dungeon_40',
    name: 'Luyện hư tuần đãng',
    description: 'Hoàn thành 40 phó bản trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 40,
    requiredRealmOrder: 6,
  ...
  {
    key: 'weekly_T5_boss_hit_80',
    name: 'Luyện hư chiến boss tuần',
    description: 'Đánh trúng Thế Giới Boss 80 lần trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'BOSS_HIT',
    goalAmount: 80,
    requiredRealmOrder: 6,
  ...
  {
    key: 'weekly_T5_gain_exp_500000',
    name: 'Luyện hư đạo tâm',
    description: 'Tích luỹ 500000 EXP trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'GAIN_EXP',
    goalAmount: 500000,
    requiredRealmOrder: 6,
  ...
  {
    key: 'weekly_T5_sect_contribute_3000',
    name: 'Luyện hư tông môn tuần',
    description: 'Cống hiến 3000 điểm cho tông môn trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'SECT_CONTRIBUTE',
    goalAmount: 3000,
    requiredRealmOrder: 6,
    ...
    rewards: {
      linhThach: 60000,
      congHien: 3000,
      items: [{ itemKey: 'cuu_thien_dan', qty: 2 }],
    },
    realmTier: 'luyen_hu',
  },
  {
    key: 'weekly_T5_kill_monster_500',
    name: 'Luyện hư trảm yêu tuần',
    description: 'Hạ gục 500 yêu thú trong tuần (yêu cầu Luyện Hư).',
    period: 'WEEKLY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 500,
    requiredRealmOrder: 6,
  ...
  // ---------- WEEKLY tier 6 (Đại Thừa / Độ Kiếp — realm order 8-9) ----------
  {
    key: 'weekly_T6_clear_dungeon_50',
    name: 'Đại thừa tuần đãng',
    description: 'Hoàn thành 50 phó bản trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'CLEAR_DUNGEON',
    goalAmount: 50,
    requiredRealmOrder: 8,
  ...
  {
    key: 'weekly_T6_boss_hit_120',
    name: 'Đại thừa chiến boss tuần',
    description: 'Đánh trúng Thế Giới Boss 120 lần trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'BOSS_HIT',
    goalAmount: 120,
    requiredRealmOrder: 8,
  ...
  {
    key: 'weekly_T6_gain_exp_2000000',
    name: 'Đại thừa đạo tâm',
    description: 'Tích luỹ 2000000 EXP trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'GAIN_EXP',
    goalAmount: 2000000,
    requiredRealmOrder: 8,
    ...
    rewards: {
      linhThach: 150000,
      items: [{ itemKey: 'than_dan', qty: 2 }],
    },
    realmTier: 'dai_thua',
  },
  {
    key: 'weekly_T6_alchemy_craft_15',
    name: 'Đại thừa luyện đan tuần',
    description: 'Luyện thành công 15 viên đan dược trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'ALCHEMY_CRAFT',
    goalAmount: 15,
    requiredRealmOrder: 8,
  ...
  {
    key: 'weekly_T6_kill_monster_800',
    name: 'Đại thừa trảm yêu tuần',
    description: 'Hạ gục 800 yêu thú trong tuần (yêu cầu Đại Thừa).',
    period: 'WEEKLY',
    goalKind: 'KILL_MONSTER',
    goalAmount: 800,
    requiredRealmOrder: 8,
