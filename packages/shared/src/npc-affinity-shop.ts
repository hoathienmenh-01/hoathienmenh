...
export const NPC_AFFINITY_SHOPS: readonly NpcAffinityShopItemDef[] = [
  ...
  // ─── Phase 33 — Quyển II–IV NPC affinity shop minimal entries ─────────────
  {
    npcKey: 'npc_luc_binh',
    itemKey: 'linh_lo_dan',
    requiredAffinityTier: 'quen_biet',
    ...
    stockType: 'weekly',
    weeklyLimit: 2,
    unlockHint: 'Lục Bình đổi đan dược lấy mảnh xích tin tức.',
    unlockHintEn: 'Lục Bình trades pills for chain-shard intel.',
  },
  {
    ...
    stockType: 'weekly',
    weeklyLimit: 1,
    unlockHint: 'Thánh Sứ trao một viên đan dược như lời mời tranh luận tiếp.',
    unlockHintEn: 'The Saint Envoy offers a pill as an invitation to continue the debate.',
  },
  {
    ...
    stockType: 'weekly',
    weeklyLimit: 1,
    unlockHint: 'Đạo Vực Chi Tâm tặng vật phẩm khi luật mềm được áp dụng.',
    unlockHintEn: 'The Dao Domain Heart grants a token when soft law is upheld.',
  },
  {
    ...
    stockType: 'weekly',
    weeklyLimit: 1,
    unlockHint: 'Nguyên Linh Nữ cấp một giọt bản nguyên cho người tôn trọng Bản Nguyên Hải.',
    unlockHintEn: 'Nguyên Linh Nữ grants a drop of origin-water to those who respect the Origin Sea.',
  },
  {
    ...
    stockType: 'weekly',
    weeklyLimit: 1,
    unlockHint: 'Giám Quan đổi câu khắc lấy một viên Linh Lộ Đan.',
    unlockHintEn: 'The Inspector trades an inscription for a Linh Lộ pill.',
  },
  {
    ...
    stockType: 'weekly',
    weeklyLimit: 1,
    unlockHint: 'Lão nhân câu được một viên Linh Lộ Đan từ Thời Gian Luân Hải.',
    unlockHintEn: 'The old man fishes a Linh Lộ pill from the River of Time.',
  },
  {
    ...
    stockType: 'weekly',
    weeklyLimit: 1,
    unlockHint: 'Đồng tử trao một viên đan dược từ tương lai gần.',
    unlockHintEn: 'The boy hands over a pill from the near future.',
  },
] as const;
